...
// Initialize low-level sqlite connection (as in the tutorial)
dbConnection
  .getDbConnection()
  .then((db) => {
    init(db);
...
// Initialize / reset the database via Knex (used by /dbinitialize)
const dbinitialize = async () => {
  await testBase.resetDatabase(knex_db);
  return { status: "Database initialized" };
};

// ============== Teacher related DB functions ==============
